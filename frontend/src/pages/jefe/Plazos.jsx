...
const Plazos = () => {
  ...
  const [editingPlazos, setEditingPlazos] = useState(null);
  ...
  const handleToggleActivo = async (periodo) => {
    try {
      ...
      await plazosService.updatePeriodo(periodo.id, nuevoEstado);
      setSuccess(`Periodo ${nuevoEstado ? "activado" : "desactivado"} exitosamente`);
      await loadPeriodos();
      setTimeout(() => setSuccess(""), 3000);
    } catch (err) {
      console.error("Error updating periodo:", err);
      setError("Error al actualizar el periodo académico");
    }
  };
        ...
        <div className="periodos-grid">
          {periodos.map((periodo) => (
            ...
            >
              ...
              <div className="periodo-card-header">
                ...
                <div className="periodo-actions">
                  <button
                    ...
                    onClick={() => handleToggleActivo(periodo)}
                    title={periodo.activo ? "Desactivar periodo" : "Activar periodo"}
                  >
              ...
              {/* Plazos */}
              {periodo.plazos && (
                <div className="plazos-section">
                  <h4 className="plazos-section-title">Plazos Habilitados</h4>
                    ...
                    <div className="plazo-item">
                      <div className="plazo-info">
                        ...
                        <div className="plazo-content">
                          ...
                          <span className="plazo-description">Subida de documentos estudiantiles</span>
                        </div>
                      </div>
                      <button
                        className={`plazo-toggle ${periodo.plazos.documentos ? "active" : ""}`}
                        onClick={() => handleTogglePlazo(periodo.id, "documentos", periodo.plazos.documentos)}
                      >
                        <span className="toggle-slider"></span>
                      </button>
                    </div>
                    ...
                    <div className="plazo-item">
                      <div className="plazo-info">
                        ...
                        <div className="plazo-content">
                          ...
                          <span className="plazo-description">Matrícula e inscripción de asignaturas</span>
                        </div>
                      </div>
                      <button
                        className={`plazo-toggle ${periodo.plazos.inscripcion ? "active" : ""}`}
                        onClick={() => handleTogglePlazo(periodo.id, "inscripcion", periodo.plazos.inscripcion)}
                      >
                        <span className="toggle-slider"></span>
                      </button>
                    </div>
                    ...
                    <div className="plazo-item">
                      <div className="plazo-info">
                        ...
                        <div className="plazo-content">
                          ...
                          <span className="plazo-description">Cambios en matrícula e información</span>
                        </div>
                      </div>
                      <button
                        className={`plazo-toggle ${periodo.plazos.modificaciones ? "active" : ""}`}
                        onClick={() => handleTogglePlazo(periodo.id, "modificaciones", periodo.plazos.modificaciones)}
                      >
                        <span className="toggle-slider"></span>
                      </button>
                    </div>
